/* @ts-self-types="./minisearch_rs.d.ts" */
...
export class JsEngine {
    static __wrap(ptr) {
        const obj = Object.create(JsEngine.prototype);
        obj.__wbg_ptr = ptr;
        JsEngineFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        JsEngineFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_jsengine_free(ptr, 0);
    }
    /**
    ...
    addDocument(id, text) {
        try {
            ...
            wasm.jsengine_addDocument(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1);
     ...
     */
    docCount() {
        const ret = wasm.jsengine_docCount(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    static fromBytes(bytes) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.jsengine_fromBytes(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
     ...
     */
    constructor() {
        const ret = wasm.jsengine_new();
        this.__wbg_ptr = ret;
        JsEngineFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     * @returns {any}
     */
    search(query, top_k, corpus) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(query, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            wasm.jsengine_search(retptr, this.__wbg_ptr, ptr0, len0, top_k, addHeapObject(corpus));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
     ...
     */
    termCount() {
        const ret = wasm.jsengine_termCount(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    toBytes() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jsengine_toBytes(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
...
if (Symbol.dispose) JsEngine.prototype[Symbol.dispose] = JsEngine.prototype.free;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./minisearch_rs_bg.js": import0,
    };
}

const JsEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_jsengine_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('minisearch_rs_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
